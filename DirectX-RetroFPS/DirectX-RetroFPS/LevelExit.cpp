...
LevelExit::LevelExit(Graphics& graphics)
{
...
void LevelExit::Update(float deltaTime)
{
	m_playerColliding = false;
}

void LevelExit::OnCollision(CollisionUtilities::ColliderCollision collision, DrawableBase* other)
{
...
bool LevelExit::IsColliding()
{
	return m_playerColliding;
}

void LevelExit::InitialiseStatic(Graphics& graphics)
{
	struct Vertex
	{
